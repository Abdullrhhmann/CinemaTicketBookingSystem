...
public:
	void editmovies(string m, string g, string s, string r)
	{
		movieName = m;
		genre = g;
		status = s;
...
void editmovieSelect() // to select an option from the edit movie  screen
{
	...
	if (input == 1)
	{
		...
		cout << "press 1 to edit movies or 2 for main screen :  ";
		int input;
		cin >> input;

		if (input == 1)
		{
               cout<< "press 1 to edit movies or 2 to delete movies : ";
               int in;
               cin>>in;
               if(in==1){
			string m, g, s, r;
			cout << "enter mov ie name : ";
			cin >> m;
			cout << endl
				<< "enter movie genre : ";
			cin >> g;
			...
			int n;
			cin >> n;
			M[n - 1].editmovies(m, g, s, r);
			cout << "movie added !!" << endl;
			cout << "press 1 to go to main screen : ";
               }
               else if(in==2)
               {
                    cout << "enter the number of the movie you want to delete(1-10) : ";
                    int n;
			cin >> n;
			M[n - 1].editmovies();
...
{
	M[0].editmovies("the God Father ", "Drama", "Avilable", "+16");
	M[1].editmovies("interstellar", "SI-FI", "Avilable", "+10");
	M[2].editmovies("Fight Club", "Drama", "Avilable", "+12");
	M[3].editmovies("Oppenheimer", "Drama", "Coming soon", "+12");
     M[4].editmovies("endgame","action","avilable","+3");
}
void bookmovieScreen()
{
	cout << "                   ****************************************************                                  " << endl;
...
void selectseat()
{
	...
	for (int i = 0; i < 1; i++)
	{
		...
		else if (a == 'e' || a == 'f' || a == 'g' || a == 'h' || a == 'i' || a == 'j' || a == 'k'||a == 'E' || a == 'F' || a == 'G' || a == 'H' || a == 'I' || a == 'J' || a == 'K')
		{
			sum += C.priceGold;
		}
		else if (a == 'l' || a == 'm' || a == 'n' || a == 'o'|| a == 'L'|| a == 'M'|| a == 'N'|| a == 'O')
		{
			sum += C.pricePlat;
		}
	}
     cout <<"Do you wish to get one of  Le Grand Rex combo snacks ?(Y/N) ";
     char comb;
     cin>>comb;
     if(comb=='Y'||comb=='y'){

          cout <<"                                         Avilable combos :                                             "<<endl;
          cout <<"                                                                                                                    "<<endl;
          cout <<"1#"<<"                                         Le Grand Snack          20-EURO                                      "<<endl;
          cout <<"2#"<<"                                         Le Grand Big Man      50-EURO                                    "<<endl;
          cout <<"3#"<<"                                         Le Grand Lux              120-EURO                                   "<<endl;
          cout <<"                              your choice :-->)";
          int chos;
          cin>>chos;
          if(chos==1){
               cout <<"you selected :  Le Grand Snack  "<<endl<<"Price : 20-EURO"<<endl;
               sum+=20;
               snack ="Le-Grand-Snack";
          }else if(chos==2){
               cout <<"you selected :  Le Grand Big Man  "<<endl<<"Price : 50-EURO"<<endl;
               sum+=50;
               snack ="Le-Grand-Big-Man";
          }else if(chos==3){
               cout <<"you selected :  Le Grand Lux "<<endl<<"Price : 120-EURO"<<endl;
               sum+=120;
                snack ="Le-Grand-Lux";
          }else{}
	...
	cout << endl << "NAME :           " << se.myName << endl
		...
		<< "TIME :     9-PM" << endl
		<< "SCREEN :     2 " << endl
		<< "DATE :      31/12/2022" << endl << "SNACK : "<<snack<<endl;
